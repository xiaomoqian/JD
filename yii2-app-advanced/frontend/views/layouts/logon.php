...
<div class="topnav">
    <div class="topnav_bd w990 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>
                    <?php echo isset(Yii::$app->user->identity->username)?"您好[".Yii::$app->user->identity->username."]，欢迎来到今夕":''?>
...
<div class="header w990 bc mt15">
    <div class="logo w1210">
        <h2 class="fl"><?=\yii\helpers\Html::a(\yii\helpers\Html::img("@web/images/logo.png"),['index/index'])?></h2>
    </div>
</div>
<!-- 页面头部 end -->
<?= $content ?>
