...
<div class="main w1210 mt10 bc">
    ...
    <div class="goods_content fl mt10 ml10">
        <!-- 商品概要信息 start -->
        <div class="summary">
            <h3><strong>ThinkPad X230(23063T4）<?=$goods->name?>（i5-3230M 7000 HD4000 薄荷金 WIN8PRC 十年保障）</strong></h3>

            <!-- 图片预览区域 start -->
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$goods->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$goods->logo?>" alt="" width="350" height="350"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
...
<!--                            </li>-->
                            ...
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: '<?=$img->img?>',largeimage: '<?=$img->img?>'}">
<!--                                   rel="{gallery: 'gal1', smallimage: 'images/preview_m3.jpg',largeimage: 'images/preview_l3.jpg'}">-->
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="market_price"><span>定价：</span><em><?=$goods->stock_price?></em></li>
                ...
                <form action="flow" method="post" class="choose">
                    <ul>
        ...
        <div class="detail">
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            <li><span>商品名称：</span>ThinkPadX230(<?=$goods->name?>）</li>
                            <li><span>商品编号：</span><?=$goods->sn?></li>
                            <li><span>品牌：</span><?=$goods->name?>（Thinkpad）</li>
