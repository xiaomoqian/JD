...
<div class="list w1210 bc mt10">
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="sort mt10">
            <dl>
                <dt>排序：</dt>
                <dd class="cur"><?=\yii\helpers\Html::a("销量",['#']);?></dd>
                <dd><?=\yii\helpers\Html::a("价格",['#']);?></dd>
                <dd><?=\yii\helpers\Html::a("评论数",['#']);?></dd>
                <dd><?=\yii\helpers\Html::a("上架时间",['#']);?></dd>
            </dl>
        </div>
        <!-- 排序 end -->
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><?=\yii\helpers\Html::a('<img src="'.$v->logo.'" alt="" />',['goods','id'=>$v->id])?></dt>
                        <dd><a href=""><?=$v->name?></a></dt>
                        <dd><strong>￥<?=$v->shop_price?></strong></dt>
                        <dd><a href=""><em>已有<?=$v->cate_id?>人评价</em></a></dt>
                    </dl>
                </li>
                <?php endforeach;?>
            </ul>
