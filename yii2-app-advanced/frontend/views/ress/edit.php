...
<!--                //关闭csrf-->
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" value="<?=$model->name?>" name="Ress[name]" class="txt" />
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" value="<?=$model->address?>" name="Ress[address]" class="txt address"  />
                    </li>
                    <li>
                        <label for=""><span>*</span>手机号码：</label>
                        <input type="text" value="<?=$model->mobile?>" name="Ress[mobile]" class="txt" />
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox"  <?php  if($model->status=='1'){echo "checked";}?> name="Ress[status]" class="check" />设为默认地址
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
