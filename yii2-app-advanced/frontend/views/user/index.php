        ...
        <div class="login_form fl">
            <form action="" method="post">
                ...
                <ul>
                    ...
                    <li>
                        <label for="">密码：</label>
                        <input type="password" class="txt" name="User[password_hash]" />
                    ...
                    <li>
                        <label for="">邮箱：</label>
                        <input type="email" class="txt" name="User[email]" />
                        <p>邮箱必须合法</p>
                    </li>
                    <li>
                        <label for="">手机号码：</label>
                        <input type="text" class="txt" value="" name="User[tel]" id="tel" placeholder=""/>
                    </li>
                    <li>
                        <label for="">验证码：</label>
